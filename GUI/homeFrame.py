...
from GUI.checkInFrame import CheckInFrame
from GUI.checkOutFrame import CheckOutFrame
from GUI.availableRoomsFrame import AvailableRoomsFrame
from GUI.getInfoFrame import GetInfoFrame
