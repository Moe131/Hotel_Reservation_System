...
class GetInfoFrame :
    ...
    def __init__(self):
        ...
        headerLabel = tk.Label(self._root, text = "Guest Information", font= "Times 20")
        ...
        firstNameLabel2.grid(row= 5, column = 1)
        lastNameLabel.grid(row= 6, column = 0)
        lastNameLabel2.grid(row= 6, column = 1)
        emailLabel.grid(row= 7, column = 0)
        emailLabel2.grid(row= 7, column = 1)
        phoneLabel.grid(row= 8 , column = 0)
        phoneLabel2.grid(row= 8 , column = 1)
        roomTypeLabel.grid(row=9, column = 0)
        roomTypeLabel2.grid(row=9, column = 1)
